...
### 1. Tenant & Branding (`backend.apps.tenants`)
...
### 2. Customer Management (`backend.apps.customer_management`)
...
### 3. Invoicing & Payments (`backend.apps.payments_management`)
...
### 4. System Configuration (`backend.apps.setup`)
