...
![alt text](./images/notification-flow.png)
...
![alt text](./images/notification-flow-2.png)
...
Notifications use the **ALERT** or **DLQ** failure tiers defined in the [Asynchronous Architecture](../backend/documentation/Asynchronus_Architecture.md):
